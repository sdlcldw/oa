...
CREATE TABLE `data_bm` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='学校部门';
...
INSERT INTO `data_bm` VALUES (2,'学生科'),(3,'教务科'),(4,'督查科'),(5,'人事科'),(6,'财务科'),(7,'总务科'),(8,'校领导');

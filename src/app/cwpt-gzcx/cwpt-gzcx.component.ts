...
@Component({
  selector: 'app-cwpt-gzcx',
  templateUrl: './cwpt-gzcx.component.html',
  styleUrls: ['./cwpt-gzcx.component.css']
})
export class CwptGzcxComponent implements OnInit,AfterViewInit {
